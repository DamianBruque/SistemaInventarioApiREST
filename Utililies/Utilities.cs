...
namespace Utililies
{
    public static class Utilities
    {
        ...
        /// <returns></returns>
        public static T Map<T, U>(U entity) // T es el tipo de dato que queremos devolver, U es el tipo de dato que recibimos
        {
            ...
            return mapper.Map<U, T>(entity); // devolvemos el resultado del mapeo de entity a T usando mapper
        }
    }
}
